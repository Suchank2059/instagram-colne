    ...
    <main class="grid grid-cols-12 gap-3 h-full w-full overflow-hidden">
        <aside class="lg:col-span-7 m-auto items-center w-full overflow-scroll-hidden">
            <label for="customFileInput" class="m-auto max-w-fit flex-col flex gap-3 cursor-pointer">
                <input id="customFileInput" multiple accept=".jpg.png.jpeg" type="file" class="sr-only">
                <span class="m-auto">
            ...
            {{-- flex --}} hidden
             overflow-x-scroll w-[500px] h-96 snap-x snap-mandatory gap-2 px-2">
                ...
                <div class="w-full h-full snap-always shrink-0 snap-center">
                    ...
                    <img src="https://images.unsplash.com/photo-1682688759457-52bcb4dc1578?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxfHx8ZW58MHx8fHx8"
        ...
        <aside class="lg:col-span-5 h-full border-l p-3 flex gap-4 flex-col overflow-hidden overflow-y-scroll-hidden">
            ...
            <div>
                <textarea class="border-0 focus-border-0 px-0 w-full rounded-lg bg-white h-32 focus:outline-none focus:ring-0"
                    name="" id="" cols="30" rows="10" placeholder="Add a caption"></textarea>

            </div>

            <div class="w-full items-center">
                <input type="text" name="" id="" placeholder="Add a location"
