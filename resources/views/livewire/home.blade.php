<div class="w-full h-full">
    ...
    {{-- Header --}}
    <header class="lg:hidden sticky top-0 bg-white">
        ...
        <aside class="lg:col-span-4 hidden lg:block p-4">
            ...
            <section class="mt-5">
                ...
                <ol class="flex gap-2 flex-wrap">
                    <li class="text-xs text-gray-800/90 font-medium gap-4">
                ...
                <h3 class="text-gray-800/90 mt-6 text-sm">@ 2023 INSTAGRAM CLONE</h3>
